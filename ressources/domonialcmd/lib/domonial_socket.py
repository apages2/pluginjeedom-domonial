...
logger = logging.getLogger('domonialcmd')
...
class domonialcmdSocketAdapter(object, StreamRequestHandler):
	def __init__(self, address='192.168.0.246', port=8000):
